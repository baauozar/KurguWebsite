...
namespace KurguWebsite.Persistence.Migrations
{
    ...
    [Migration("20250928171943_fixtablesddddaaa")]
    partial class fixtablesddddaaa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KurguWebsite.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("KurguWebsite.Domain.Entities.CaseStudyMetric", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CaseStudyId", "MetricName");

                    b.ToTable("CaseStudyMetrics", (string)null);
                });
            ...
            modelBuilder.Entity("KurguWebsite.Persistence.Context.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KurguWebsite.Domain.Entities.CaseStudyMetric", b =>
                {
                    b.HasOne("KurguWebsite.Domain.Entities.CaseStudy", "CaseStudy")
                        .WithMany("Metrics")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("KurguWebsite.Persistence.Context.ApplicationUser", null)
                        .WithMany()
